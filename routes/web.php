...
//Coupn Controller
Route::get('/CouponListPage', [CouponListController::class,'CouponListPage'])->middleware('loginCheck');
Route::post('/CouponListSingleData', [CouponListController::class,'CouponListSingleData'])->middleware('loginCheck');
Route::get('/CouponListData', [CouponListController::class,'CouponListData'])->middleware('loginCheck');
Route::post('/CouponListAdd', [CouponListController::class,'CouponListAdd'])->middleware('loginCheck');
Route::post('/CouponListUpdate', [CouponListController::class,'CouponListUpdate'])->middleware('loginCheck');
Route::post('/CouponListDelete', [CouponListController::class,'CouponListDelete'])->middleware('loginCheck');
