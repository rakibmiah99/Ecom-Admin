        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="printDiv" class="container">
                    ...
                    <div class="row">
                        <div class="col-6 d-flex flex-row">
                            <p>
                                ...
                                Kistimath.com <br>
                                10/25, Estern Plaza, Sonargaon Road,Hatirpol, Dhaka
                            </p>
                        </div>
                        <div class="col-6 d-flex flex-row-reverse">
                            <p>
                    ...
                    <div class="row">
                        <div class="col-12 d-flex flex-row-reverse">
                            <p><strong>Delivery Charge:</strong> <span id="delivery_charge"></span> <br></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 d-flex flex-row-reverse">
                            <p><strong>Total:</strong> <span id="total_price"></span></p>
                        </div>
                    </div>
                </div>
            </div>
