...
<head>
    ...
    <title>Kistimath Ecommerce</title>
    ...
    <aside class="main-sidebar sidebar-dark-danger elevation-1">
        <a href="/" class="brand-link">
            <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Kistimath Ecommerce</span>
        </a>
        <div class="sidebar ">
            <nav class="mt-2 pb-4">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{url('/CouponListPage')}}" class="nav-link"><i class="nav-icon far fa-user-circle"></i><p>Coupon</p>
                        </a>
                    </li>
                    <li class="nav-item">
