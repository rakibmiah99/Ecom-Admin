...
class ProductDetailsController extends Controller
{
    ...
    function ProductDetailsWithOneImg(Request $request){
        ...
        $imageOne="http://".$_SERVER['HTTP_HOST']."/storage/app/public/".$product_image_1_fileName;
    ...
    function ProductDetailsWithTwoImg(Request $request){
        ...
        $imageTwo="http://".$_SERVER['HTTP_HOST']."/storage/app/public/".$product_image_2_fileName;
    ...
    function ProductDetailsWithThreeImg(Request $request){
        ...
        $imageThree="http://".$_SERVER['HTTP_HOST']."/storage/app/public/".$product_image_3_fileName;
    ...
    function ProductDetailsAdd(Request $request){
        ...
        $imageFour="http://".$_SERVER['HTTP_HOST']."/storage/app/public/".$product_image_4_fileName;
    ...
    function ChangeProductImageOne(Request $request){
        ...
        $NewPhotoURL="http://".$_SERVER['HTTP_HOST']."/storage/app/public/".$NewPhotoName;
